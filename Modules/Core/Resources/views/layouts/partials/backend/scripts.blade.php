...
<script src="{{assetsCoreGlobalVendor()}}/moment/moment.min.js"></script>
...
<script src="{{assetsCoreGlobalVendor()}}/toolbar/jquery.toolbar.js"></script>
...
<script src="{{assetsCoreGlobal()}}/js/Plugin/toolbar.js"></script>


<script src="{{moduleAssets('core')}}/jquery.highlight.js"></script>
<script src="{{asset("public/assets/bower/bower.js")}}"></script>
<script src="{{moduleAssets('core')}}/backend-common.js"></script>
